...
const excludedFiles = ['package-lock.json', 'package.json', 'countAllLines.js']; // Замените на файлы, которые хотите исключить
const excludedDirs = ['storage', 'node_modules']; // Замените на папки, которые хотите исключить
